...
class CounterModel extends ChangeNotifier {
  ...
  Map<String, String> operator [](int index) => _dataList[index];
...
class _xiaofeiqingdanState extends State<xiaofeiqingdan> {
  ...
  final _dataList = CounterModel(); // 存储用户输入的数据
                  ...
                  children: [
                    Expanded(
                      ...
                      itemBuilder: (context, index) {
                        final data = _dataList._dataList[index];
                        return Row(
